%
% NOTE -- ONLY EDIT howtogenefinder.Rnw!!!
% Biobase.tex file will get overwritten.
%
%\VignetteIndexEntry{HowTo: Genefinder}
%\VignetteDepends{genefilter}
%\VignetteKeywords{Expression Analysis}
%\VignettePackage{genefinder}
...
\begin{document}
\title{How To Find Genes Close to Specified Genes}
...
(consistent with the \verb+geneNames+ of the exprSet).
...
<<>>=
 ...
 closeg <- genefinder(eset, igenes, 10, method="euc", scale="none")
 names(closeg)
@
...
<<>>=
closeg$"31539_r_at"
Nms1 <- geneNames(eset)[closeg$"31539_r_at"$indices]
Nms1
@
%$
