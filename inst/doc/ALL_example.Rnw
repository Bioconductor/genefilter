...
\title{ALL example, illustrating function use}
...
% \VignetteIndexEntry{Example code for new filtering functions.}
...
This vignette illustrates use of several functions added to the
\emph{genefilter} package:
