...
c
c  Modified by R. Gentleman, 2004, just extracted the ttest stats

      subroutine fastt(d,n,ng,ng1,z,dm, eqv)
      real d(n,ng),z(n),dm(n)
      integer n,ng,ng1,ng2,eqv
c  initialize
      ng2=ng-ng1
      do 61 i=1,n
         call tst2GM(d(i,1),ng1,ng2,n,z(i),dm(i), eqv)
 61   continue
      return
      end

      subroutine tst2GM(d,ng1,ng2,n,tst,dm, eqv)
c columns 1 to ng1 in group 1, ng1+1 to ng1+ng2 in group 2
      real d(n,ng1+ng2),tst,dm
      double precision dm1,dm2,dss1,dss2
      integer ng1,ng2,n,i,eqv
      dm1=0
      dm2=0
      dss1=0
      dss2=0
