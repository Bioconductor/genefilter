...
for independent filtering~\cite{Bourgon:2010:PNAS}. In
particular, it provides diagnostics that are intended to help with
\begin{packeditemize}
...
<<figdifferentstats,fig=TRUE,width=5.5,height=5.5>>=
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=0.49\textwidth]{independent_filtering-figdifferentstats}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.5\textwidth]{independent_filtering-fighistindepfilt}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.49\textwidth]{independent_filtering-sortedP}
\includegraphics[width=.49\textwidth]{independent_filtering-SchwederSpjotvoll}
