...
\begin{figure}[ht]
\centering
\includegraphics[width=.49\textwidth]{figure/figscatterindepfilt}
\includegraphics[width=.49\textwidth]{figure/figecdffilt}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.49\textwidth]{figure/figbadfilter}
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=0.49\textwidth]{figure/figrejection}
\includegraphics[width=0.49\textwidth]{figure/fignumreject}
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=0.49\textwidth]{figure/figdifferentstats}
...
\begin{figure}[ht]
\centering
\includegraphics[width=.5\textwidth]{figure/fighistindepfilt}
