...
Here `f1` is a function that implies our "expression measure above 200 in at least 5 samples" criterion, the function `ffun` is the filtering function (which in this case consists of only one criterion), and we apply it using `genefilter`. There were  `r {sum(wh1)}` genes that satisfied the criterion and passed the filter.
