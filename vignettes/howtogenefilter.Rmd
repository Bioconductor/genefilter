...
Here, `ttest` is a function from the `r Biocpkg("genefilter")` package which provides a suitable wrapper around \texttt{t.test} from package `r Biocpkg("stats")`. Now we see that there are `{r (wh2) results="hide"} ` genes that satisfy the selection criterion.
