...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=0.49\textwidth]{figure/filter_volcano}
\includegraphics[width=0.49\textwidth]{figure/kappa}
...
\begin{figure}[tb]
\begin{center}
\includegraphics[width=0.49\textwidth]{figure/rejection_plot}
\includegraphics[width=0.49\textwidth]{figure/filtered_R_plot}
